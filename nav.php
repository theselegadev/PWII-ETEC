        ...
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="./CRUD/App/View/listaDisciplina.php">Disciplinas</a></li>
              <li><a class="dropdown-item" href="./CRUD/App/View/listaReferencia.php">Referencias</a></li>
            </ul>
          </li>
        </ul>
      </div>
